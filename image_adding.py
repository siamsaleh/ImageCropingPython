...
#     img_over_original_r = Image.open(r"imagesTransparentRight/" + "trans-right-" + right_file_names[index])
#
#     # Resize
...
#     img_over_original_l = Image.open(r"imagesTransparentLeft/" + "trans-left-" + left_none_file_names[index])
#
#     # Resize
